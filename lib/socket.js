...
internals.Socket.prototype._authenticate = async function (request) {
    ...
    if (request.auth) {
        ...
        if (config.type === 'direct') {
            ...
            request.auth.headers['x-forwarded-proto'] = this.info['x-forwarded-proto'];
            request.auth.headers['x-forwarded-host'] = this.info['x-forwarded-host'];
            request.auth.headers['x-forwarded-port'] = this.info['x-forwarded-port'];
            request.auth.headers['x-forwarded-path'] = this.info['x-forwarded-path'];
